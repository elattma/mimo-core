...
export default function IntegratedItems() {
  return (
    <div className="flex w-full min-w-full flex-col space-y-theme-1/2">
...
const itemVariants = cva(
  "flex select-none items-center space-x-theme-1/2 rounded-theme border p-theme-1/2 transition-colors hover:cursor-pointer",
  {
    variants: {
      selected: {
        true: "border-brand-border bg-brand-bg text-brand-text-contrast hocus:border-brand-border-hover hocus:bg-brand-bg-hover active:bg-brand-bg-active",
        false:
          "border-neutral-border text-gray-text hocus:border-neutral-border-hover hocus:bg-neutral-bg-hover active:bg-neutral-bg-active",
      },
    },
  }
);
...
function Items() {
  ...
  if (integratedItems.length === 0) {
    ...
    return (
      <div className="flex flex-col gap-theme-1/2">

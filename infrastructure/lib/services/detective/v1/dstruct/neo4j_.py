...
class Neo4j:
    ...
    def pages(self, pages: List[Node]):
        ...
        for page in pages:
            ...
            if not (page.properties and 'connection' in page.properties and 'type' in page.properties and 'last_updated_timestamp' in page.properties and 'summary' in page.properties):

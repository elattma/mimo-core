...
@dataclass
class UserConnectionItem(ParentChildItem):
    ...
    def get_child(self):
        return KeyNamespaces.CONNECTION + self.connection.id if self.connection else None
    ...
    def as_dict(self):
        ...
        return {
            'parent': self.parent,
            'child': KeyNamespaces.CONNECTION + self.connection.id,
